    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          padding:
              EdgeInsets.symmetric(horizontal: mediaQuery.widthPercentage(5)),
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                // Sección 1: Títulos (Login)
                Text(
                  AppStrings.login,
                  style: theme.textTheme.headlineLarge,
                ),
                // Sección 1: Títulos (Get Start)
                Text(
                ...
                Center(
                  child: TextButton(
                    onPressed: () => GoRouter.of(context).go(AppRouters.signUp),
                    child: Text.rich(
                      TextSpan(
